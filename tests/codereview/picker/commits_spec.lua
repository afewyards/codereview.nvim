...
describe("commits picker", function()
  describe("build_entries", function()
    it("builds picker entries from commits", function()
      local commits = {
        { sha = "abc12345full", short_sha = "abc12345", title = "Fix login", author = "alice", created_at = "2026-03-01T10:00:00Z" },
        { sha = "def67890full", short_sha = "def67890", title = "Add tests", author = "bob", created_at = "2026-02-28T10:00:00Z" },
      }
    ...
    it("includes since-last-review when last_reviewed_sha provided", function()
      ...
      for _, e in ipairs(entries) do
        if e.type == "since_last_review" then found = true end
      end
