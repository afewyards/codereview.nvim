...
function M.setup()
  ...
  vim.api.nvim_set_hl(0, "CodeReviewLogSectionHeader", { link = "Title", default = true })
  vim.api.nvim_set_hl(0, "CodeReviewFloatFooter", { link = "FloatFooter", default = true })
  ...
  -- Pipeline
  vim.api.nvim_set_hl(0, "CodeReviewPipelineSuccess", { fg = "#9ece6a", default = true })
  vim.api.nvim_set_hl(0, "CodeReviewPipelineFailed", { fg = "#f7768e", default = true })
  vim.api.nvim_set_hl(0, "CodeReviewPipelineRunning", { fg = "#7aa2f7", default = true })
  vim.api.nvim_set_hl(0, "CodeReviewPipelinePending", { fg = "#e0af68", default = true })
  vim.api.nvim_set_hl(0, "CodeReviewPipelineManual", { fg = "#828bb8", default = true })
  vim.api.nvim_set_hl(0, "CodeReviewPipelineCanceled", { fg = "#565f89", default = true })
  vim.api.nvim_set_hl(0, "CodeReviewPipelineStage", { fg = "#c8d3f5", bold = true, default = true })
  vim.api.nvim_set_hl(0, "CodeReviewPipelineDuration", { fg = "#565f89", default = true })
  vim.api.nvim_set_hl(0, "CodeReviewCursorHidden", { blend = 100, nocombine = true, default = true })
